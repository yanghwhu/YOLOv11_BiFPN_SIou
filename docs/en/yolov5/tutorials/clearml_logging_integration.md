...
```bash
python train.py --img 640 --batch 16 --epochs 3 --data tomb.yaml --weights yolov5s.pt --cache
```

or with custom project and task name:

```bash
python train.py --project my_project --name my_training --img 640 --batch 16 --epochs 3 --data tomb.yaml --weights yolov5s.pt --cache
```
