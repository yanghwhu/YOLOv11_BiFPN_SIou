...
class HUBDatasetStats:
    ...
    Args:
        path (str): Path to data.yaml or data.zip (with data.yaml inside data.zip). Default is 'tomb.yaml'.
    ...
    def __init__(self, path="tomb.yaml", task="detect", autodownload=False):
        """Initialize class."""
