...
def bbox_iou(box1, box2, xywh=True,GIoU=False,DIoU=False,CIoU=False,EIou = False,SIou = False,alpha = 1, eps=1e-7):
    ...
    if CIoU or DIoU or GIoU or EIou:
        ...
        if CIoU or DIoU or GIoU or EIou:  # Distance or Complete IoU https://arxiv.org/abs/1911.08287v1
            ...
            if CIoU:  # https://github.com/Zzh-tju/DIoU-SSD-pytorch/blob/master/utils/box/box_utils.py#L47
                ...
                s_ch = (b2_y1 + b2_y1 -b1_y1 - b1_y2) *0.5 +eps
